  ...
  first: function () {
    ...
    setTimeout(
      function() {
        ...
        infoRect.setAttribute("scale", "1.4 1.3 0.02");
        infoRect.setAttribute("position", "0 1.23 0.5");
        ...
        title.setAttribute("position", "-0.3 1.5 0.54");
        ...
        info1.setAttribute("position", "-0.26 1.36 0.54");
        info1.setAttribute("material", "color: white");
        info1.setAttribute("text-geometry", "value: This is the first task; size: 0.04; height: 0.001;");
        $(".active-task").get(0).appendChild(info1);

        var info2 = document.createElement("a-entity");
        info2.setAttribute("class", "first-task-popup");
        info2.setAttribute("position", "-0.32 1.26 0.54");
        info2.setAttribute("material", "color: white");
        info2.setAttribute("text-geometry", "value: of the actual experiment; size: 0.04; height: 0.001;");
